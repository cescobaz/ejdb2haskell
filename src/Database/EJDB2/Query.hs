...
setBoolAtIndex :: Bool
               ...
               -> Query
               -> IO ()
setBoolAtIndex bool index (Query jql _) =
    c_jql_set_bool jql
                   nullPtr
...
setI64 :: Int64
       ...
       -> Query
       -> IO ()
setI64 number placeholder (Query jql _) = withCString placeholder $
...
setI64AtIndex :: Int64
              ...
              -> Query
              -> IO ()
setI64AtIndex number index (Query jql _) =
...
setString :: String
          ...
          -> Query
          -> IO ()
setString string placeholder (Query jql _) =
...
setStringAtIndex :: String
                 ...
                 -> Query
                 -> IO ()
setStringAtIndex string index (Query jql _) = withCString string $ \cString ->
