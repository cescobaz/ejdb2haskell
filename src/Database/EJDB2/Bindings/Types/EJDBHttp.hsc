...
instance Storable EJDBHttp where
        ...
        peek ptr = do
           ...
           return $ EJDBHttp enabled port bind (access_token, access_token_len) blocking read_anon max_body_size
        poke ptr (EJDBHttp enabled port bind (access_token, access_token_len) blocking read_anon max_body_size) = do
