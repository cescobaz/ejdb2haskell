...
curl http://localhost:9191/plants -d '{"name":"pinus","isTree":true,"year":1753,"description":"wow 🌲"}'
...
curl http://localhost:9191/plants -d '{"name":"leucanthemum vulgare","isTree":false,"year":1778,"description":"very common flower in Italy 🍕"}'
